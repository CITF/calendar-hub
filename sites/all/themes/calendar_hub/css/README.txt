...
To use these stylesheets, rename the files and calendar_hub with the name of your theme.
...
calendar_hub-alpha-default.css
...
calendar_hub-alpha-default-narrow.css  
...
calendar_hub-alpha-default-normal.css
...
calendar_hub-alpha-default-wide.css
